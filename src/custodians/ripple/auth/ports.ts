/**
 * Injected I/O ports for the Custody adapter.
 *
 ...
 * implementation lives in the transport layer; tests use a fake.
 *
 * The token endpoint is the separate Custody auth server (`auth.tokenUrl`), not
 * part of the Custody OpenAPI surface — so these are hand-authored SDK-internal
 * types with no generated counterpart, as CLAUDE.md permits.
 */
