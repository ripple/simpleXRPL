...
Defined in: [custodians/local/local-signer.ts:31](https://github.com/ripple/simpleXRPL/blob/main/src/custodians/local/local-signer.ts#L31)
...
Defined in: [custodians/local/local-signer.ts:36](https://github.com/ripple/simpleXRPL/blob/main/src/custodians/local/local-signer.ts#L36)
