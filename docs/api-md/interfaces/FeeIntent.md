...
Defined in: [domain/model.ts:84](https://github.com/ripple/simpleXRPL/blob/main/src/domain/model.ts#L84)
...
Defined in: [domain/model.ts:81](https://github.com/ripple/simpleXRPL/blob/main/src/domain/model.ts#L81)
