...
Defined in: [ports/http.ts:51](https://github.com/ripple/simpleXRPL/blob/main/src/ports/http.ts#L51)
...
Defined in: [ports/http.ts:53](https://github.com/ripple/simpleXRPL/blob/main/src/ports/http.ts#L53)
